/** Shared ML-viewer file helpers (kept local to avoid cross-lib coupling). */

export function formatMlFileSize(bytes: number): string {
...
export function getMlFileExtension(fileName: string): string {
