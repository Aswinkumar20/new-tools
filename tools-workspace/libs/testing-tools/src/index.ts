...
export * from './lib/component/user-agent-parser/user-agent-parser';
export * from './lib/component/credit-card-validator/credit-card-validator';
export * from './lib/component/jwt-decoder/jwt-decoder';
