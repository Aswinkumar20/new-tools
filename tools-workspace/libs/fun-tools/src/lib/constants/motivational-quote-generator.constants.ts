...
export const MQG_HISTORY_LIMIT = 50;

/** Suggest focus tools after this many generations in a session. */
export const MQG_FOCUS_SESSION_THRESHOLD = 5;

export const MOTIVATIONAL_QUOTES: ReadonlyArray<MotivationalQuote> = [
...
export const MQG_RELATED_TOOLS: ReadonlyArray<FtRelatedToolLink> = [
  {
    label: 'Pomodoro Timer',
    path: '/fun-tools/pomodoro-timer',
    description: 'Channel inspiration into a focused work interval'
  },
  {
    label: 'Flashcard & Quiz Generator',
    path: '/fun-tools/flashcard-quiz-generator',
    description: 'Turn favorite quotes into Q&A study cards'
  },
  {
    label: 'Typing Speed Test',
    path: '/fun-tools/typing-speed-test',
    description: 'Practice typing by copying a quote as a passage'
  },
  {
    label: 'Stopwatch & Timer',
    path: '/fun-tools/stopwatch-timer',
    description: 'Time reflection or journaling after a quote'
  },
  {
    label: 'Lorem Ipsum Generator',
    path: '/fun-tools/lorem-ipsum-generator',
    description: 'Need layout filler instead of real quotes? Generate placeholder text'
  }
];
