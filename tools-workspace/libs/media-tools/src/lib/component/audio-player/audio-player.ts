...
import {
  ...
  MEDIA_AUDIO_RELATED_TOOLS,
  AUDIO_TRACK_LOAD_DELAY_MS,
  AUDIO_VIS_CANVAS_HEIGHT,
  AUDIO_VIS_COLORS,
  AUDIO_VIS_FFT_SIZE
} from '../../constants/media-audio-player.constants';
import type { AudioRepeatMode, AudioTrackFile } from '../../types/media-audio-player.types';
import {
  clampVolumePercent,
  cycleRepeatMode,
...
} from '../../utils/media-audio-player.utils';
...
export class AudioPlayerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  readonly relatedTools: ReadonlyArray<MtRelatedToolLink> = MEDIA_AUDIO_RELATED_TOOLS;
