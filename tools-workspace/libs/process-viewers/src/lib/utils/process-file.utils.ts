/** Shared process-viewer file helpers (kept local to avoid cross-lib coupling). */

export function formatProcessFileSize(bytes: number): string {
...
export function getProcessFileExtension(fileName: string): string {
